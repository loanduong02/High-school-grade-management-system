...
<table align='center' width='1200' border='1' cellspacing="10" cellpadding="5" >
...
foreach($hocsinh as $row) {
	...
	echo "<td><a href='hocsinh/sua_hs.php?cma=$row[MaHS]'><button type='button'>Sửa</button></a></td>";
    echo "<td><a href='hocsinh/xoa_hs.php?cma=$row[MaHS]' onclick='return XacNhan();'><button type='button'>Xóa</button></a></td>";
	echo "</tr>";
}
